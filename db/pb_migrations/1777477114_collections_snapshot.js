...
migrate((app) => {
  const snapshot = [
    ...
    },
    {
      ...
      "id": "pbc_2649858105",
      "indexes": [
        "CREATE UNIQUE INDEX `idx_voices_name_user` ON `voices` (`name`, `user`)"
      ],
    ...
    {
      "createRule": "voice.user = @request.auth.id",
      "deleteRule": "voice.user = @request.auth.id",
      "fields": [
        {
          "autogeneratePattern": "[a-z0-9]{15}",
          "hidden": false,
      ...
      "id": "pbc_2849149333",
      "indexes": [],
      "listRule": "voice.user = @request.auth.id || voice.public = true",
      "name": "voice_samples",
      "system": false,
      "type": "base",
      "updateRule": "voice.user = @request.auth.id",
      "viewRule": "voice.user = @request.auth.id || voice.public = true"
    },
    {
      "createRule": "@request.auth.id != ''",
      "deleteRule": "user = @request.auth.id",
      ...
      "id": "pbc_2769025244",
      "indexes": [
        "CREATE UNIQUE INDEX `idx_settings_key_user` ON `settings` (`key`, `user`)"
      ],
      "listRule": "user = @request.auth.id",
      "name": "settings",
      "system": false,
