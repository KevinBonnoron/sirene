  ...
  return (
    <div className="flex min-h-screen bg-background">
      ...
      <div className="relative hidden overflow-hidden bg-bg-elevated lg:flex lg:w-1/2">
        <div className="absolute inset-0 bg-gradient-to-br from-primary/10 via-transparent to-accent-violet/5" />
        <div className="relative z-10 mx-auto flex w-full max-w-md flex-col items-center justify-center p-12 text-center">
          <img src="/sirene.svg" alt="" className="size-20 rounded-2xl shadow-lg shadow-primary/10" />
      ...
      <div className="relative flex flex-1 flex-col items-center justify-center px-5 py-12 sm:p-10">
        <div className="absolute inset-0 bg-gradient-to-b from-primary/10 via-transparent to-transparent lg:hidden" />
        <div className="relative z-10 w-full max-w-[420px]">
          <div className="mb-8 flex flex-col items-center gap-4 text-center lg:hidden">
            <img src="/sirene.svg" alt="" className="size-16 rounded-2xl shadow-lg shadow-primary/10" />
