  ...
  return (
    <div className="space-y-2">
      ...
      <div className="relative">
        ...
        <Button type="button" variant="ghost" size="icon" aria-label={visible ? t('form.hidePassword') : t('form.showPassword')} aria-pressed={visible} aria-controls={id} className="absolute right-0 top-0 h-full px-3 text-muted-foreground hover:text-foreground" onClick={() => setVisible((v) => !v)}>
