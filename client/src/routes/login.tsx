        ...
        <div className="w-full max-w-[420px]">
          ...
          <Card className="border-0 shadow-none sm:border sm:shadow-sm">
            <CardContent className="p-0 sm:p-8">
              <div className="mb-8">
                <h2 className="text-2xl font-bold tracking-tight">{mode === 'login' ? t('auth.welcome') : t('auth.createAccount')}</h2>
                <p className="mt-2 text-sm text-muted-foreground">{mode === 'login' ? t('auth.welcomeSubtitle') : t('auth.createAccountSubtitle')}</p>
              </div>
              ...
              {mode === 'login' ? (
                ...
                <form key="register" onSubmit={handleRegister} className="space-y-5">
                  <div className="space-y-2">
